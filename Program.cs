...
internal class Program : IApiMarker
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddScoped<IDatabase, DataStore.Database>();
        ...
        builder.Services.Configure<GoogleCloudStorageOptions>(
            builder.Configuration.GetSection(GoogleCloudStorageOptions.Key));
        ...
        builder.Services.AddRefitClient<IPublishedFileServiceApi>(
            ...
            .ConfigureHttpClient(client =>
                client.BaseAddress = new Uri("https://api.steampowered.com/IPublishedFileService/"));
