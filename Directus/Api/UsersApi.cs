...
internal class UsersApi : BaseApi<UsersFilterBuilder, UsersFactory, UserModel>
{
    /// <inheritdoc />
    public UsersApi(IDirectusClient client)
        : base(client)
    {
    }

    /// <inheritdoc />
    protected override string Collection => "users";
}
